...
final class Template {
	 ...
	 */
	private static $args = [
		'main_template_dir' => 'vendor/het-weblokaal/wbl-theme-foundation/templating'
	];
	 ...
	 */
	public static function display( $slug, $hierarchy = null, $args = [], $directory = 'template-parts' ) {
		...
		do_action( "get_template_part_{$slug}", "{$directory}/{$slug}", $hierarchy, $args );
	...
	/**
	 * Wrapper for display function to make loading of templates easier
	 */
	public static function display_template( $slug, $hierarchy = null, $args = [] ) {

		static::display( $slug, $hierarchy, $args, 'templates' );
